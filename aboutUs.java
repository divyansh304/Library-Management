...
public class aboutUs extends JFrame{
	...
	private JPanel contentPane;
        ...
        public aboutUs() {
            ...
            JLabel l6 = new JLabel("Developed By : DIVYANSH SHANDILYA");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l7 = new JLabel("Contact Us : divyanshtyagi304@gmail.com");
            ...
            JLabel l9 = new JLabel("Follow us on Instagram : divyanshtyagiii");
            l9.setFont(new Font("Trebuchet MS", Font.BOLD , 20));
            l9.setBounds(70, 320, 600, 34);
            contentPane.add(l9);


            JLabel l10 = new JLabel("**7678609685*");
